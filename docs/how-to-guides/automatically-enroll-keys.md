...
You can also use the experimental option of `sbctl` to read the checksums of
your OptionRoms from the TPM eventlog and enroll these in your firmware:
...
If you don't have OptionRoms you're worried about and don't want to enroll the
Microsoft keys or read checksums from the TPM eventlog, you can. However, this
has the potential to soft brick your system and you should only enable this
option if you know what you're doing and have the means to recover from a
potential soft brick. Set this option to not enroll the Microsoft keys:
